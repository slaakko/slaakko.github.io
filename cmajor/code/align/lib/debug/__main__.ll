; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/align/lib/debug/__main__.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/align/lib/debug/__main__.cm"
...
@4 = private unnamed_addr constant [69 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/align/lib/debug/__main__.cm\00"
...
entry:
  ...
  call void @RtEnterFunction(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([69 x i8], [69 x i8]* @4, i32 0, i32 0))
  store i32 %0, i32* %2
  store i8** %1, i8*** %3
...
catchpad:                                         ; preds = %handlers
  ...
  %16 = call i1 @RtHandleException(i32 2090762) [ "funclet"(token %15) ]
