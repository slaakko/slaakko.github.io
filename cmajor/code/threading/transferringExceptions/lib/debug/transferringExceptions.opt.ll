; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/threading/transferringExceptions/lib/debug/transferringExceptions.ll'
...
entry:
  ...
  call void @RtThrowException(i8* %6, i32 4524208)
...
next5:                                            ; preds = %next7, %resume, %next3
  call void @RtExitFunction()
  ret void
