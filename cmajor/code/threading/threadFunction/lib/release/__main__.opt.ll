; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/threading/threadFunction/lib/release/__main__.ll'
...
entry:
  ...
  tail call void @RtEnterFunction(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([90 x i8], [90 x i8]* @1, i64 0, i64 0))
