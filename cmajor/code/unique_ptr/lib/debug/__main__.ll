; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/unique_ptr/lib/debug/__main__.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/unique_ptr/lib/debug/__main__.cm"
...
@2 = private unnamed_addr constant [66 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/unique_ptr/unique_ptr.cm\00"
...
@4 = private unnamed_addr constant [74 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/unique_ptr/lib/debug/__main__.cm\00"
...
false:                                            ; preds = %entry
  call void @RtFailAssertion(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([67 x i8], [67 x i8]* @1, i32 0, i32 0), i8* getelementptr inbounds ([66 x i8], [66 x i8]* @2, i32 0, i32 0), i32 81)
  br label %next
}
...
entry:
  ...
  call void @RtEnterFunction(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @4, i32 0, i32 0))
  store i32 %0, i32* %2
  store i8** %1, i8*** %3
...
catchpad:                                         ; preds = %handlers
  ...
  %16 = call i1 @RtHandleException(i32 2132919) [ "funclet"(token %15) ]
