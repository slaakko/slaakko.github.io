; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/xml/xpath/lib/debug/__main__.ll'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/xml/xpath/lib/debug/__main__.cm"
...
@4 = private unnamed_addr constant [73 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/xml/xpath/lib/debug/__main__.cm\00"
...
entry:
  ...
  %9 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([73 x i8], [73 x i8]* @4, i32 0, i32 0))
...
catchpad:                                         ; preds = %handlers
  ...
  %16 = call i1 @RtHandleException(i32 7277838) [ "funclet"(token %15) ]
