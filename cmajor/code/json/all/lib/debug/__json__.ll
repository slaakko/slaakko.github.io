; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/all/lib/debug/__json__.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/all/lib/debug/__json__.cm"
...
@1 = private unnamed_addr constant [72 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/all/lib/debug/__json__.cm\00"
@2 = private unnamed_addr constant [7 x i8] c"Member\00"
@3 = private unnamed_addr constant [14 x i8] c"DerivedMember\00"
@4 = private unnamed_addr constant [5 x i8] c"Beta\00"
@5 = private unnamed_addr constant [6 x i8] c"Alpha\00"
...
entry:
  ...
  %2 = alloca { i64, i64, i8* }
  %3 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([72 x i8], [72 x i8]* @1, i32 0, i32 0))
  call void @RtSetLineNumber(i32 -1)
  call void @constructor_String_char_1A2E459753926DA4BB6C50F78EAA85228F458D8D({ i64, i64, i8* }* %0, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @2, i32 0, i32 0))
  call void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }* %0, i8* ({ i8* }*)* @member_function_Create_Member_6A65ED3A5159DAF6390349BF94E738777C390C48)
  call void @destructor_String_char_F7B4C17640DD66A10201C90F77AD5AB049E425FB({ i64, i64, i8* }* %0)
  call void @constructor_String_char_1A2E459753926DA4BB6C50F78EAA85228F458D8D({ i64, i64, i8* }* %1, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @3, i32 0, i32 0))
  call void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }* %1, i8* ({ i8* }*)* @member_function_Create_DerivedMember_362D131BDF8C27AC8F334C10965488A934E5B474)
  call void @destructor_String_char_F7B4C17640DD66A10201C90F77AD5AB049E425FB({ i64, i64, i8* }* %1)
  call void @constructor_String_char_1A2E459753926DA4BB6C50F78EAA85228F458D8D({ i64, i64, i8* }* %2, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @4, i32 0, i32 0))
  call void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }* %2, i8* ({ i8* }*)* @member_function_Create_Beta_811C01C9EB68E15AFC18B64D34230CECDB49B910)
  call void @destructor_String_char_F7B4C17640DD66A10201C90F77AD5AB049E425FB({ i64, i64, i8* }* %2)
  call void @constructor_String_char_1A2E459753926DA4BB6C50F78EAA85228F458D8D({ i64, i64, i8* }* %3, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @5, i32 0, i32 0))
  call void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }* %3, i8* ({ i8* }*)* @member_function_Create_Alpha_6AFA528F2521F54BDE60A2F258A64DD4F49A6771)
...
declare i8* @member_function_Create_Member_6A65ED3A5159DAF6390349BF94E738777C390C48({ i8* }*)

declare void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }*, i8* ({ i8* }*)*)

declare i8* @member_function_Create_DerivedMember_362D131BDF8C27AC8F334C10965488A934E5B474({ i8* }*)

declare i8* @member_function_Create_Beta_811C01C9EB68E15AFC18B64D34230CECDB49B910({ i8* }*)

declare i8* @member_function_Create_Alpha_6AFA528F2521F54BDE60A2F258A64DD4F49A6771({ i8* }*)
