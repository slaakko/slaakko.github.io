; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/exportable/lib/debug/__json__.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/exportable/lib/debug/__json__.cm"
...
@1 = private unnamed_addr constant [79 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/exportable/lib/debug/__json__.cm\00"
@2 = private unnamed_addr constant [27 x i8] c"MyNs.MyJsonExportableClass\00"
...
entry:
  %0 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([79 x i8], [79 x i8]* @1, i32 0, i32 0))
  call void @RtSetLineNumber(i32 -1)
  call void @constructor_String_char_1A2E459753926DA4BB6C50F78EAA85228F458D8D({ i64, i64, i8* }* %0, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @2, i32 0, i32 0))
  call void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }* %0, i8* ({ i8* }*)* @member_function_Create_MyJsonExportableClass_55AED1F92830B08D6D89B3FE95A7D69D68AE416C)
...
declare i8* @member_function_Create_MyJsonExportableClass_55AED1F92830B08D6D89B3FE95A7D69D68AE416C({ i8* }*)
