; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/constructible/lib/debug/__json__.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/constructible/lib/debug/__json__.cm"
...
@1 = private unnamed_addr constant [82 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/json/constructible/lib/debug/__json__.cm\00"
@2 = private unnamed_addr constant [30 x i8] c"MyNs.MyJsonConstructibleClass\00"
...
entry:
  %0 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([82 x i8], [82 x i8]* @1, i32 0, i32 0))
  call void @RtSetLineNumber(i32 -1)
  call void @constructor_String_char_1A2E459753926DA4BB6C50F78EAA85228F458D8D({ i64, i64, i8* }* %0, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @2, i32 0, i32 0))
  call void @function_RegisterJsonClass_2FBE4E8832266A3352BF1717BFB867612A99D471({ i64, i64, i8* }* %0, i8* ({ i8* }*)* @member_function_Create_MyJsonConstructibleClass_D9CFB7FF95D5AD9D80795EF30A818D7F192CC5EA)
...
declare i8* @member_function_Create_MyJsonConstructibleClass_D9CFB7FF95D5AD9D80795EF30A818D7F192CC5EA({ i8* }*)
