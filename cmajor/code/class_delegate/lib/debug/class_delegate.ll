; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/class_delegate/class_delegate.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/class_delegate/class_delegate.cm"
...
$default_constructor_Alpha_561BADF8814AD2D30ED0CF0C5C1F17FCFE7313F7 = comdat any

@0 = private unnamed_addr constant [22 x i8] c"Alpha.foo(Alpha, int)\00"
@1 = private unnamed_addr constant [74 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/class_delegate/class_delegate.cm\00"
@2 = private unnamed_addr constant [17 x i8] c"foo called with \00"
@3 = private unnamed_addr constant [22 x i8] c"Alpha.bar(Alpha, int)\00"
@4 = private unnamed_addr constant [17 x i8] c"bar called with \00"
@5 = private unnamed_addr constant [17 x i8] c"Alpha.baz(Alpha)\00"
@6 = private unnamed_addr constant [17 x i8] c"Alpha.fuz(Alpha)\00"
...
define void @member_function_foo_Alpha_DF5B3CC3111F6A0C7FEFDBCD6FF1CD0C294A0558({ { i8*, void (i8*, i32)* } }*, i32) #1 {
entry:
  %2 = alloca { { i8*, void (i8*, i32)* } }*
  %3 = alloca i32
  %4 = alloca { i64, i64, i8* }
  %5 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @1, i32 0, i32 0))
  store { { i8*, void (i8*, i32)* } }* %0, { { i8*, void (i8*, i32)* } }** %2
  store i32 %1, i32* %3
  call void @RtSetLineNumber(i32 6)
  call void @RtSetLineNumber(i32 7)
  %6 = load i32, i32* %3
  call void @function_ToString_45DAFF73E9D4870570132FAB4BF547270338BCA8(i32 %6, { i64, i64, i8* }* %4)
  call void @function_op_plus_C05BF76A6B8273257BCDC08A1CE38DE9745E72FA(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @2, i32 0, i32 0), { i64, i64, i8* }* %4, { i64, i64, i8* }* %5)
...
; Function Attrs: uwtable
define void @member_function_bar_Alpha_E27D8257E516DC59354CDF3CDE75CE3CD491E5BB({ { i8*, void (i8*, i32)* } }*, i32) #1 {
entry:
  %2 = alloca { { i8*, void (i8*, i32)* } }*
  %3 = alloca i32
  %4 = alloca { i64, i64, i8* }
  %5 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @3, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @1, i32 0, i32 0))
  store { { i8*, void (i8*, i32)* } }* %0, { { i8*, void (i8*, i32)* } }** %2
  store i32 %1, i32* %3
  ...
  %6 = load i32, i32* %3
  call void @function_ToString_45DAFF73E9D4870570132FAB4BF547270338BCA8(i32 %6, { i64, i64, i8* }* %4)
  call void @function_op_plus_C05BF76A6B8273257BCDC08A1CE38DE9745E72FA(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @4, i32 0, i32 0), { i64, i64, i8* }* %4, { i64, i64, i8* }* %5)
  call void @member_function_WriteLine_Console_9AFE70B5869360AF73603AA32F58F1860A016BBC({ i64, i64, i8* }* %5)
  call void @RtExitFunction()
  ret void
}
...
; Function Attrs: uwtable
define void @member_function_baz_Alpha_9F33BF90D89DAFCEB1BE9DE6DEB513297D590201({ { i8*, void (i8*, i32)* } }*) #1 {
entry:
  %1 = alloca { { i8*, void (i8*, i32)* } }*
  %2 = alloca { i8*, void (i8*, i32)* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @5, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @1, i32 0, i32 0))
  store { { i8*, void (i8*, i32)* } }* %0, { { i8*, void (i8*, i32)* } }** %1
  call void @RtSetLineNumber(i32 14)
  %3 = bitcast { { i8*, void (i8*, i32)* } }** %1 to i8*
  %4 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 0
  store i8* %3, i8** %4
  %5 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 1
  store void (i8*, i32)* bitcast (void ({ { i8*, void (i8*, i32)* } }*, i32)* @member_function_bar_Alpha_E27D8257E516DC59354CDF3CDE75CE3CD491E5BB to void (i8*, i32)*), void (i8*, i32)** %5
  %6 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 0
  %7 = load i8*, i8** %6
  %8 = load { { i8*, void (i8*, i32)* } }*, { { i8*, void (i8*, i32)* } }** %1
  %9 = getelementptr { { i8*, void (i8*, i32)* } }, { { i8*, void (i8*, i32)* } }* %8, i32 0, i32 0
  %10 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %9, i32 0, i32 0
  store i8* %7, i8** %10
  %11 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 1
  %12 = load void (i8*, i32)*, void (i8*, i32)** %11
  %13 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %9, i32 0, i32 1
  store void (i8*, i32)* %12, void (i8*, i32)** %13
  call void @RtExitFunction()
  ret void
}

; Function Attrs: uwtable
define void @member_function_fuz_Alpha_645E28E069BD3E64D5776A3D211EEB24361B5F3D({ { i8*, void (i8*, i32)* } }*) #1 {
entry:
  %1 = alloca { { i8*, void (i8*, i32)* } }*
  call void @RtEnterFunction(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @6, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @1, i32 0, i32 0))
  store { { i8*, void (i8*, i32)* } }* %0, { { i8*, void (i8*, i32)* } }** %1
  call void @RtSetLineNumber(i32 18)
  call void @RtSetLineNumber(i32 19)
  %2 = load { { i8*, void (i8*, i32)* } }*, { { i8*, void (i8*, i32)* } }** %1
  %3 = getelementptr { { i8*, void (i8*, i32)* } }, { { i8*, void (i8*, i32)* } }* %2, i32 0, i32 0
  %4 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %3, i32 0, i32 1
  %5 = load void (i8*, i32)*, void (i8*, i32)** %4
  %6 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %3, i32 0, i32 0
  %7 = load i8*, i8** %6
  call void %5(i8* %7, i32 24)
  call void @RtExitFunction()
  ret void
}

; Function Attrs: nounwind
define linkonce_odr void @default_constructor_Alpha_561BADF8814AD2D30ED0CF0C5C1F17FCFE7313F7({ { i8*, void (i8*, i32)* } }*) #0 comdat {
entry:
  %1 = alloca { { i8*, void (i8*, i32)* } }*
  store { { i8*, void (i8*, i32)* } }* %0, { { i8*, void (i8*, i32)* } }** %1
  %2 = load { { i8*, void (i8*, i32)* } }*, { { i8*, void (i8*, i32)* } }** %1
  %3 = getelementptr { { i8*, void (i8*, i32)* } }, { { i8*, void (i8*, i32)* } }* %2, i32 0, i32 0
  %4 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %3, i32 0, i32 0
  store i8* null, i8** %4
  %5 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %3, i32 0, i32 1
  store void (i8*, i32)* null, void (i8*, i32)** %5
  ret void
}

; Function Attrs: uwtable
define void @function_main_30D71DA93A80E84640D467E0841F28966485AC6A() #1 {
entry:
  %0 = alloca { { i8*, void (i8*, i32)* } }
  %1 = alloca { i8*, void (i8*, i32)* }
  %2 = alloca { i8*, void (i8*, i32)* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @7, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @1, i32 0, i32 0))
  call void @RtSetLineNumber(i32 25)
  call void @default_constructor_Alpha_561BADF8814AD2D30ED0CF0C5C1F17FCFE7313F7({ { i8*, void (i8*, i32)* } }* %0)
  %3 = bitcast { { i8*, void (i8*, i32)* } }* %0 to i8*
  %4 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 0
  store i8* %3, i8** %4
  %5 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 1
  store void (i8*, i32)* bitcast (void ({ { i8*, void (i8*, i32)* } }*, i32)* @member_function_foo_Alpha_DF5B3CC3111F6A0C7FEFDBCD6FF1CD0C294A0558 to void (i8*, i32)*), void (i8*, i32)** %5
  %6 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 0
  %7 = load i8*, i8** %6
  %8 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %1, i32 0, i32 0
  store i8* %7, i8** %8
  %9 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %2, i32 0, i32 1
  %10 = load void (i8*, i32)*, void (i8*, i32)** %9
  %11 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %1, i32 0, i32 1
  store void (i8*, i32)* %10, void (i8*, i32)** %11
  call void @RtSetLineNumber(i32 28)
  %12 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %1, i32 0, i32 1
  %13 = load void (i8*, i32)*, void (i8*, i32)** %12
  %14 = getelementptr { i8*, void (i8*, i32)* }, { i8*, void (i8*, i32)* }* %1, i32 0, i32 0
  %15 = load i8*, i8** %14
  call void %13(i8* %15, i32 42)
  call void @RtSetLineNumber(i32 29)
  call void @member_function_baz_Alpha_9F33BF90D89DAFCEB1BE9DE6DEB513297D590201({ { i8*, void (i8*, i32)* } }* %0)
  call void @RtSetLineNumber(i32 30)
  call void @member_function_fuz_Alpha_645E28E069BD3E64D5776A3D211EEB24361B5F3D({ { i8*, void (i8*, i32)* } }* %0)
  call void @RtExitFunction()
  ret void
}
