; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/min/min.cm'
source_filename = "C:/Users/Seppo/cmajorw64/cmajor/doc/code/min/min.cm"
target datalayout = "e-m:w-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-windows-msvc"

$function_Min_41729366E46554AADAC09A036001ACC198746159 = comdat any
...
@1 = private unnamed_addr constant [52 x i8] c"C:/Users/Seppo/cmajorw64/cmajor/doc/code/min/min.cm\00"
@2 = private unnamed_addr constant [15 x i8] c"Min(3, 2) == 2\00"
@3 = private unnamed_addr constant [4 x i8] c"bug\00"

; Function Attrs: nounwind
define linkonce_odr i8* @function_Min_41729366E46554AADAC09A036001ACC198746159(i8*, i8*) #0 comdat {
entry:
  %2 = alloca i8*
  %3 = alloca i8*
  store i8* %0, i8** %2
...
entry:
  ...
  %3 = alloca i8
  %4 = alloca i8
  call void @RtEnterFunction(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @1, i32 0, i32 0))
...
true:                                             ; preds = %entry
  ...
  call void @member_function_WriteLine_Console_9FE02332C7669B128638EA7B0A2A2EE07C3A0A17(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @2, i32 0, i32 0))
  br label %next
...
false:                                            ; preds = %entry
  ...
  call void @member_function_WriteLine_Console_9FE02332C7669B128638EA7B0A2A2EE07C3A0A17(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @3, i32 0, i32 0))
  br label %next
}
