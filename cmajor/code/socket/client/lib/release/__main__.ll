; ModuleID = 'C:/Users/Seppo/cmajorw64/cmajor/doc/code/socket/client/lib/release/__main__.cm'
...
entry:
  ...
  %9 = alloca { i64, i64, i8* }
  call void @RtEnterFunction(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @0, i32 0, i32 0), i8* getelementptr inbounds ([79 x i8], [79 x i8]* @1, i32 0, i32 0))
...
catchpad:                                         ; preds = %handlers
  ...
  %16 = call i1 @RtHandleException(i32 1385600) [ "funclet"(token %15) ]
